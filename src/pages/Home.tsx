...
const initialNoticias: Noticia[] = [
  {
    ...
    resumo: 'O esquadrão anunciou oficialmente sua participação no maior evento virtual de aviação da América Latina.',
    imagem: headerImage
  },
  {
    data: '02 Set, 2026',
    titulo: 'Abertura de seletiva para novos alas',
    resumo: 'A central de alistamento foi atualizada com novos horários. Estamos buscando pilotos virtuais dedicados.',
    imagem: headerImage
  },
  {
    data: '28 Ago, 2026',
    titulo: 'Atualização das Texturas Oficiais',
  ...
  return (
    <div id="top">
      <style>{`
        ...
        .btn-primary:hover, .nav-btn-highlight:hover {
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div className="nav-links" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            ...
            <a href="/intranet" style={{ fontWeight: 600, color: '#f59e0b', fontSize: '0.85rem', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              <Lock size={14}/> Intranet
            </a>
      ...
      {/* 3. AERONAVE & MODS (COM IMAGEM NO FUNDO) */}
      <div style={{ backgroundColor: '#0b1121', position: 'relative', overflow: 'hidden' }}>
        
        {/* A-29 COMO BACKGROUND GIGANTE E TRANSLÚCIDO */}
        <div style={{ 
        ...
        <section id="aeronave" className="section-container" style={{ padding: '6rem 2rem', position: 'relative', zIndex: 1 }}>
          ...
          <div id="mods" style={{ paddingTop: '3rem', marginTop: '4rem', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ 
              width: '100%', maxWidth: '1000px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem',
              marginTop: modsOpen ? '2.5rem' : '0',
              maxHeight: modsOpen ? '1000px' : '0', 
              opacity: modsOpen ? 1 : 0, 
              overflow: 'hidden', 
      ...
      {/* 5. SOBRE E PALAVRA DO COMANDANTE */}
      <div style={{ backgroundColor: '#0b1121' }}>
        <section id="sobre" className="section-container" style={{ padding: '6rem 2rem' }}>
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '3rem' }}>
            ...
            <div className="glass-panel" style={{ padding: '3rem', background: 'linear-gradient(to right, rgba(245, 158, 11, 0.05), transparent)', borderLeft: '4px solid #f59e0b', borderTop: '1px solid rgba(255,255,255,0.05)', borderRight: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
              <h3 style={{ fontFamily: '"Quantico", sans-serif', color: '#f59e0b', fontSize: '1.2rem', marginBottom: '1rem', textTransform: 'uppercase', letterSpacing: '0.1em', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <Quote size={20} /> Palavra do Comandante
              </h3>
      ...
      <div style={{ backgroundColor: '#030712' }}>
          ...
          <div className="glass-panel alistamento-box" style={{ padding: '2.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', background: 'rgba(11, 17, 33, 0.6)', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <form onSubmit={submitAlistamento} style={{ width: '100%' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                ...
                {/* Abas Minimalistas para Simulador */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', gridColumn: '1 / -1', marginTop: '0.5rem' }}>
                  ...
                  <div style={{ display: 'flex', gap: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                    {['MSFS 2020', 'MSFS 2024'].map(sim => (
                      <div 
                        key={sim} onClick={() => setSimulador(sim)}
                        style={{ cursor: 'pointer', paddingBottom: '0.5rem', borderBottom: simulador === sim ? '2px solid #f59e0b' : '2px solid transparent', color: simulador === sim ? '#f8fafc' : '#94a3b8', fontWeight: simulador === sim ? 600 : 400, transition: 'all 0.3s ease', fontSize: '0.85rem', marginBottom: '-1px' }}
                      >
                        {sim}
                      </div>
                    ))}
              ...
              <button type="submit" className="btn-primary font-title" style={{ width: '100%', marginTop: '2.5rem', letterSpacing: '0.2em', padding: '1rem', background: '#f59e0b', color: '#000', fontWeight: 700, borderRadius: '6px' }}>
                ENVIAR APLICAÇÃO
              </button>
            </form>
          </div>
        ...
        <section id="parceiros" className="section-container" style={{ padding: '3rem 2rem' }}>
          <div className="section-header" style={{ margin: 0 }}>
            <h2 className="section-title" style={{ fontSize: '1.25rem', fontFamily: '"Quantico", sans-serif', fontWeight: 700, opacity: 0.7 }}>Parceiros</h2>
          </div>
      ...
      <footer className="footer" style={{ padding: '4rem 2rem 2rem', backgroundColor: '#0b1121', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="footer-content" style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '0.8rem', lineHeight: 1.6, fontWeight: 300, margin: 0 }}>
              Simulação de alta fidelidade do A-29 Super Tucano. Honrando o legado da aviação de caça brasileira.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <a href="#pilotos" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.color = '#f59e0b'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Pilotos</a>
            <a href="#agenda" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.color = '#f59e0b'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Agenda</a>
            <a href="#aeronave" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.color = '#f59e0b'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Aeronave</a>
            <a href="#noticias" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.color = '#f59e0b'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Notícias</a>
            <a href="#sobre" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.color = '#f59e0b'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Sobre Nós</a>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', color: '#94a3b8' }}>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', background: 'rgba(255,255,255,0.05)', padding: '0.75rem', borderRadius: '6px', transition: 'all 0.3s ease' }} onMouseEnter={e => {e.currentTarget.style.color = '#f59e0b'; e.currentTarget.style.background = 'rgba(245, 158, 11, 0.1)';}} onMouseLeave={e => {e.currentTarget.style.color = 'inherit'; e.currentTarget.style.background = 'rgba(255,255,255,0.05)';}} aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', background: 'rgba(255,255,255,0.05)', padding: '0.75rem', borderRadius: '6px', transition: 'all 0.3s ease' }} onMouseEnter={e => {e.currentTarget.style.color = '#f59e0b'; e.currentTarget.style.background = 'rgba(245, 158, 11, 0.1)';}} onMouseLeave={e => {e.currentTarget.style.color = 'inherit'; e.currentTarget.style.background = 'rgba(255,255,255,0.05)';}} aria-label="YouTube">
                <Video size={20} strokeWidth={1.5} />
              </a>
              <a href="https://discord.com" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', background: 'rgba(255,255,255,0.05)', padding: '0.75rem', borderRadius: '6px', transition: 'all 0.3s ease' }} onMouseEnter={e => {e.currentTarget.style.color = '#f59e0b'; e.currentTarget.style.background = 'rgba(245, 158, 11, 0.1)';}} onMouseLeave={e => {e.currentTarget.style.color = 'inherit'; e.currentTarget.style.background = 'rgba(255,255,255,0.05)';}} aria-label="Discord">
                <DiscordIcon size={20} />
              </a>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', paddingTop: '2rem', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}>
          <p style={{ color: '#94a3b8', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.1em', opacity: 0.6, fontWeight: 300, margin: 0 }}>
            &copy; {new Date().getFullYear()} EDAV - Virtual Flight Simulator Team.
          </p>
          <p style={{ color: '#94a3b8', fontSize: '0.65rem', opacity: 0.4, fontWeight: 300, margin: 0, textAlign: 'right', maxWidth: '500px' }}>
            Não possuímos nenhum tipo de vínculo, patrocínio ou afiliação com a Força Aérea Brasileira (FAB). Este projeto visa apenas homenagear os profissionais reais através da simulação de voo.
          </p>
        </div>
      </footer>
      ...
      <button 
        ...
        style={{
          ...
          cursor: 'pointer', boxShadow: 'none', opacity: showTopBtn ? 1 : 0, pointerEvents: showTopBtn ? 'auto' : 'none',
